# This is a copy of https://github.com/bazel-contrib/rules_go/blob/master/go/tools/bazel_testing/def.bzl
# To replace repo name from "@io_bazel_rules_go" -> "@rules_go" on L18
# This is temporary, before upstream unifies all the prefixes in the repo
