...
def nogo_analyzer_deps():
    ...
    go_repository(
        ...
        sum = "h1:DJ4fh2Pv0nPKmqT646IU/0Vh5FNdGblxvF+3/W3NAUI=",
        version = "v0.11.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0CtmHq/02QhxcF7E9N5LIFcYFsMR5rdovfqTtRKkgIk=",
        version = "v1.2.2",
    )
    ...
    go_repository(
        name = "com_github_golangci_depguard_v2",
        importpath = "github.com/golangci/depguard/v2",
        sum = "h1:7HCx5L1RlH1KRijM95B57+ZraC7ddDW331jKPQY0iF4=",
        version = "v2.0.2-0.20230601235138-ed68d3771f48",
    )
    ...
    go_repository(
        ...
        sum = "h1:9aoihOQeUmluozkARyA6SETKLSJjPcYR99QdLnfvPjs=",
        version = "v1.53.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:twfIhZs4QLCtimkP7MOxlF3A0U/5cDPseRT9M/+2SCE=",
        version = "v1.5.3",
    )
    ...
    go_repository(
        name = "org_go_simpler_assert",
        importpath = "go-simpler.org/assert",
        sum = "h1:+5L/lajuQtzmbtEfh69sr5cRf2/xZzyJhFjoOz/PPqs=",
        version = "v0.5.0",
    )
